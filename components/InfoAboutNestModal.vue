    ...
    <DialogWrapper>
        <div class="modal">
            ...
            <div class="modal__text text">
                ...
                <p class="text__item">
                    You don’t need to stay on this page — the process runs entirely on our servers. Feel free to close this tab or continue with other work.
                </p>
                <p class="text__item">
