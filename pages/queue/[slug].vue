<template>
  <div class="container mx-auto p-4" v-if="data">
    ...
    <h2 class="text-2xl font-semibold text-gray-800 m-4">Nest result</h2>
    <div class="flex flex-row h-96 py-2">
      <div
        class="flex-1 flex items-center justify-center border border-gray-200 rounded-lg"
      >
        <!-- Show Progress Bar if data.resultSvg is null or does not exist -->
        ...
        <!-- Show SvgDisplay if data.resultSvg exists -->
