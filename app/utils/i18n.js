...
const dict = {
    en: {
        ...
        'demo.banner': 'Read-only sample project: {n} free demo nestings per month, full engine power (4 cores, 3 directions). Quantities are adjustable.',
        ...
        'demo.params': 'Sheet 3000 × 1500 {unit} (×3) · spacing 3 {unit} · ~90 s · 4 cores · 3 directions',
    ...
    fr: {
        ...
        'demo.banner': "Projet d'exemple en lecture seule : {n} imbrications de démonstration gratuites par mois, pleine puissance du moteur (4 cœurs, 3 sens). Les quantités sont ajustables.",
        ...
        'demo.params': 'Tôle 3000 × 1500 {unit} (×3) · espacement 3 {unit} · ~90 s · 4 cœurs · 3 sens',
