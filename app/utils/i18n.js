...
const dict = {
    en: {
        ...
        'demo.banner': 'Read-only sample project: {n} free demo nestings per month, full engine power (4 cores, 3 directions). Quantities and settings are adjustable — play with them.',
    ...
    fr: {
        ...
        'demo.banner': "Projet d'exemple en lecture seule : {n} imbrications de démonstration gratuites par mois, pleine puissance du moteur (4 cœurs, 3 sens). Quantités et réglages ajustables — amusez-vous avec.",
